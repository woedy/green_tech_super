...
class GovernmentIncentive(models.Model):
    ...
    eligible_property_types = models.JSONField(
        default=list,
        blank=True,
...
class PaymentSchedule(models.Model):
    """Individual payment schedule for a specific loan or payment plan."""
    ...
    def __str__(self):
        return f"Payment Schedule for {self.user.email} - {self.payment_plan.name}"
