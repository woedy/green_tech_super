...
export type Property = {
  ...
  status: string;
  description: string;
  // Optional sustainability/meta fields for Task 14
  greenScore?: number; // 0-100
  ecoFeatures?: string[]; // e.g., ["Solar", "Rainwater Harvesting"]
  region?: string; // Ghana region when country is Ghana
};
...
export const PROPERTIES: Property[] = [
  {
    ...
    greenScore: 72,
    ecoFeatures: ["LED Lighting", "Insulation"],
  },
  {
    id: 2,
    ...
    greenScore: 65,
    ecoFeatures: ["Low-flow Fixtures", "LED Lighting"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    greenScore: 80,
    ecoFeatures: ["Solar", "Rainwater Harvesting", "LED Lighting"],
